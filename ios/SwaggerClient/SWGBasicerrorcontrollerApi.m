#import "SWGBasicerrorcontrollerApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGInlineResponse200.h"


@interface SWGBasicerrorcontrollerApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation SWGBasicerrorcontrollerApi

static SWGBasicerrorcontrollerApi* singletonAPI = nil;
...
+(SWGBasicerrorcontrollerApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[SWGBasicerrorcontrollerApi alloc] init];
...
-(NSNumber*) errorUsingGETWithCompletionBlock: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/error"];
